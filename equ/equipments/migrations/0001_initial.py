    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_true_position', models.BooleanField(blank=True, default=True, null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('filled', 'Filled'), ('new', 'new'), ('empty', 'empty'), ('defective', 'defective')], default='new', max_length=50)),
                ('title', models.CharField(blank=True, max_length=255, null=True, verbose_name='Название')),
                ('is_true_position', models.BooleanField(blank=True, default=True, null=True)),
                ('cartridge_barcode', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='equipments.barcode')),
            ],
            options={
